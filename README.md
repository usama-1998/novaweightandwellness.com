...
- **Blog & SEO Architecture**: Fully functional blog section (`/blog`) optimized for search engines with schema.org structured data (Article, BreadcrumbList, FAQPage), Open Graph tags, canonical URLs, and integrated social sharing icons.
  ...
  - **Location-Targeted Articles**: Thirteen in-depth, long-form pillar articles targeting women in Michigan and Wisconsin, each with unique headings, structure, and locally relevant content:
    - **Mucosal Barrier Assessment (Leaky Gut Test) Pillar**: `/blog/leaky-gut-mucosal-barrier-test-michigan-wisconsin-women` (~25,000 words, 54 min read). A gut-health pillar built to close a genuine content gap, since none of the site's other articles gave "leaky gut" and the specific saliva-based Mucosal Barrier Assessment (secretory IgA, anti-gliadin antibodies, anti-candida antibodies) a dedicated, rigorous treatment. Explains intestinal permeability and tight-junction physiology (Fasano, Camilleri) in plain language, then gives the article's honest core, a dedicated section on the 2019 Ajamian et al. PLOS ONE finding that many commercial serum zonulin blood assays do not reliably detect zonulin itself, explicitly distinguishing that unreliable blood test from the saliva-based approach covered in this article and mirroring the BHRT pillar's candid WHI-study treatment rather than overselling the science. Covers why standard GI workups (colonoscopy, celiac panel) miss barrier dysfunction, the gut-thyroid/Hashimoto's molecular-mimicry connection (cross-linked to the TSH pillar), candida overgrowth and IgA depletion, perimenopause and hormone effects on the barrier, skin/brain fog/mood connections, a full evaluation and sequenced treatment protocol, five Michigan/Wisconsin composite case studies (including cases where the gut was not the answer), Michigan/Wisconsin telehealth licensing and Midwest environmental considerations (well water, older housing/mold), a 20+ term glossary, a 24-question FAQPage schema, and a references section citing only verified sources (Fasano, Camilleri/Gut 2019, Ajamian et al./PLOS ONE 2019, Corthesy/Mucosal Immunology, salivary sIgA stress research, and JACI candida/IgA research). Includes 11 custom AI-generated images (1 hero plus 10 section images) and 3 in-article CTA blocks, with zero em dashes.
    - **MRT Food Sensitivity Testing Pillar**: `/blog/food-sensitivity-testing-mrt-michigan-wisconsin-women` (~25,000 words, 54 min read). A companion gut-health pillar covering the Mediator Release Test (MRT) and LEAP elimination/reintroduction protocol, explaining why "healthy" foods can drive bloating, joint pain, brain fog, and weight resistance. Its honest core is a dedicated section explaining why food-specific IgG and IgG4 antibody testing, the type of test most people have actually heard of, is explicitly not recommended by the AAAAI, EAACI, and CSACI, then explains how MRT's mediator-release methodology differs, while being equally candid that the Commission on Dietetic Registration discontinued formal support for MRT in 2016 and that most positive outcome data is small, uncontrolled, or industry-affiliated rather than independent RCT evidence, again mirroring the BHRT pillar's non-oversold treatment of imperfect evidence. Covers allergy vs. intolerance vs. non-IgE sensitivity taxonomy, the LEAP phased elimination/reintroduction protocol end to end, common surprising trigger foods, non-celiac gluten sensitivity and anti-gliadin antibodies, the gut-immune/mast cell connection, hormone/perimenopause crosslinks, five Michigan/Wisconsin composite case studies (including a non-success case), a gold-standard double-blind placebo-controlled food challenge explainer, Michigan/Wisconsin telehealth access, a 20-term glossary, a 23-question FAQPage schema, and a references section restricted to verified sources plus non-celiac gluten sensitivity research (Elli et al. 2014, Losurdo et al.). Includes 11 custom AI-generated images (1 hero plus 10 section images) and 3 in-article CTA blocks, with zero em dashes. Cross-links reciprocally with the Mucosal Barrier Assessment pillar above, and both pillars have inbound links from the TSH and Ultimate Guide pillars. First unpublished on 2026-09-15 because only one article had been requested that day, then republished on 2026-09-17 at the client's explicit request for a second article.
...
Katie's standing preference: when asked to write "an article" or "a new blog article" without
being told to write more than one, publish exactly one article, not several. If Claude proposes
multiple candidate topics during planning, get Katie's confirmation on which single topic to
write before publishing, rather than publishing more than one by default.

A second candidate topic was drafted alongside the Mucosal Barrier Assessment pillar above (the
MRT food sensitivity testing article) but was unpublished at Katie's request on 2026-09-15 since
only one article had been asked for that day. It was republished on 2026-09-17 at Katie's
explicit request for a second article, so both pillars are live again. The standing preference
above still holds for future requests: default to one article unless told otherwise. See
`CLAUDE.md` for the same note in a form future sessions read automatically.
