...
A second candidate topic was drafted alongside the Mucosal Barrier Assessment pillar above (an
MRT food sensitivity testing article) but was unpublished at Katie's request on 2026-09-15 since
only one article had been asked for. See `CLAUDE.md` for the same note in a form future sessions
read automatically.
